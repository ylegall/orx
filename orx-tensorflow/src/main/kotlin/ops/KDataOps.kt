...
interface KDataOps {
    ...
    fun batchDataset(inputDataset : Operand<*>, batchSize : Operand<TInt64>, dropRemainder : Operand<TBool>, outputTypes : List<DataType<*>>, outputShapes : List<Shape>, options : BatchDataset.Options) : Output<TType> {
    ...
    fun serializeIterator(resourceHandle : Operand<*>, options : SerializeIterator.Options) : Output<TType> {
