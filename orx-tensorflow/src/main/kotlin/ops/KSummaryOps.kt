...
interface KSummaryOps {
    ...
    fun audioSummary(tag: Operand<TString>, tensor: Operand<TFloat32>, sampleRate: Operand<TFloat32>, vararg options: AudioSummary.Options): Output<TString> {
    ...
    fun <T : TNumber> imageSummary(tag: Operand<TString>, tensor: Operand<T>, vararg options: ImageSummary.Options): Output<TString> {
