...
interface KAudioOps {
    ...
    fun audioSpectrogram(input: Operand<TFloat32>, windowSize: Long, stride: Long, vararg options: AudioSpectrogram.Options): Output<TFloat32> {
    ...
    fun mfcc(spectrogram: Operand<TFloat32>, sampleRate: Operand<TInt32>, vararg options: Mfcc.Options): Output<TFloat32> {
