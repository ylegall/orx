...
//        renderer.postSteps.add(
//                FilterPostStep(1.0, VolumetricIrradiance(), listOf("reflections", "clipDepth"), "volumetric-irradiance", ColorFormat.RGB, ColorType.FLOAT16) {
...
//        )
        ...
        renderer.postSteps.add(
                FilterPostStep(1.0, Delinearize(), listOf("reflections"), "ldr", ColorFormat.RGB, ColorType.FLOAT16)
        )
